...
//com.mcleodgaming.ssf2.util.Key
...
package com.mcleodgaming.ssf2.util
{
    ...
    public class Key 
    {
        ...
        public static function isDown(num:int):Boolean
        {
            return (Boolean(((((!(m_disabled)) && (!(m_pressedKeys[num] == undefined))) && (!(m_pressedKeys[num] == null))) && (m_pressedKeys[num] == true))));
        }

        public static function resetKeys(e:Event):void
        {
            var i:*;
            for (i in m_pressedKeys)
            {
        ...
        public static function restartKeys(e:Event):void
        {
            m_disabled = false;
        }
